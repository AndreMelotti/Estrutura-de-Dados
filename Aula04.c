...
int main()
{
  ...
  float resultado;
    ...
    if(x.tipo != 1 && x.tipo != 2 && x.tipo != 3 && x.tipo != 4 &&  x.tipo != 5){
        printf ("Eu sei que você é idiota mas na proxima escolhe certo");
        return 0;
    }
    else{
        ...
        if(menu != 1 && menu != 2){
            printf ("Você já chegou até aqui parece que é um erro confiar em você mesmo, burro");
            return 0;
        }
        else{
            if(menu == 1 ){
